...
-- Desativa checagem de chaves estrangeiras para permitir a inserção
SET FOREIGN_KEY_CHECKS = 0;

-- Inicia transação
START TRANSACTION; 

-- Insere dados (mapeando as colunas)
...
-- Encerra a transação e salva os dados
COMMIT;

-- Reativa a validação de chaves estrangeiras
SET FOREIGN_KEY_CHECKS = 1;

-- Consulta tabela Products 
